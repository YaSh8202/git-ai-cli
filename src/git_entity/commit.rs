...
impl Commit {
    pub fn new(sha: String) -> Result<Self, GitAIError> {
    ...
    pub fn is_valid_commit(sha: &str) -> Result<(), GitAIError> {
    ...
    fn get_full_hash(sha: &str) -> Result<String, GitAIError> {
    ...
    fn get_diff(sha: &str) -> Result<String, GitAIError> {
    ...
    fn get_message(sha: &str) -> Result<String, GitAIError> {
        let output = Command::new("git")
    ...
    fn get_author_name(sha: &str) -> Result<String, GitAIError> {
        let output = Command::new("git")
    ...
    fn get_author_email(sha: &str) -> Result<String, GitAIError> {
        let output = Command::new("git")
    ...
    fn get_date(sha: &str) -> Result<String, GitAIError> {
        let output = Command::new("git")
            .args([
                "log",
                "--format=%cd",
